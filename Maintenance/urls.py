...
# from .views import CategoryListCreateAPIView,SubcategoryList,MileageList,create_product,create_repairing,ServiceList,create_warranty,SubcategoryListView,SubcategoryDetailView,SubcategoryByParentView,SubcategoryCreateView,SparePartDetail,SparePartList,get_product_by_vin,add_service,get_services,mechanical_note_create,create_history,get_history_by_product,create_service_image,create_product_service,service_create,service_list,get_service_images,get_active_check_maintenance,get_active_check_warranty,create_maintenance,newsparepart_detail
