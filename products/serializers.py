...
from .models import Category,Product,Subcategory,SparePart,Mileage,ProductService,Warranty,CheckMaintenance,MechanicalNote,History,Repairing,ServiceImage,Maintenance,newSparePart,CheckWarranty
...
class ServiceImageSerializer(serializers.ModelSerializer):
    class Meta:
        model = ServiceImage
        fields = ('user','product', 'image1', 'image2', 'image3', 'image4')
